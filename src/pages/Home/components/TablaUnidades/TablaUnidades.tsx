...
function TablaUnidades({ data }: { data: UnidadProps[] }) {
      ...
      <Table size="lg" color="#34373C" fontSize="14px">
        ...
        <Thead>
          <Tr bg="#F2F1F1">
            ...
            <ThElement key={2} text={'N° Placa'} />
            <ThElement key={3} text={'N° Serie'} />
            <ThElement key={4} text={'Color'} />
            <ThElement key={5} text={'Marca'} />
            <ThElement key={6} text={'Modelo'} />
